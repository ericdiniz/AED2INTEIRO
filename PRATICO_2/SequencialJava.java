...
public class SequencialJava {
    ...
    public static void Searcher(Serie[] s, String l, int tamanho) {
        int i = 0;
        boolean r = false;
        
        for (i = 0; i < tamanho; i++) {
            if (s[i].getNome().equals(l) == true) {
                i = tamanho;
                r = true;
            }
            Comp++;
        }
        MyIO.println(r == true ? "SIM" : "NÃO");
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // coisa do log
        RandomAccessFile raf = new RandomAccessFile("707760_sequencial", "rw");
