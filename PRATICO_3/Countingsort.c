...
//=============================================================================
int getMaior() {
    int maior = series[0].temporadas;

    for (int i = 0; i < n; i++) {
        if(maior < series[i].temporadas){
...
void selectionSort()
{
    for (int i = 0; i < n; i++)
    {
        ...
        for (int j = i + 1; j < n; j++)
        {
            if (( series[j].temporadas == series[i_menor].temporadas) && 
                strcmp(series[j].nome, series[i_menor].nome) < 0)
            {
                i_menor = j;
            }
        }
